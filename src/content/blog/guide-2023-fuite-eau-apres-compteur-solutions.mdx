...
pubDate: 2023-08-21
author: 'Léman'
image: "art10-img1.jpg"
alt: 'guide-ultime-fuite-deau-apres-compteur-2023'
width: ''
height: ''
tags: ['fuite', 'compteur']
...
import image2 from '../../images/art10-img2.jpg';
import image3 from '../../images/art10-img3.jpg';
import image4 from '../../images/art10-img4.jpg';
import image5 from '../../images/art10-img5.jpg';
    ...
    **Une petite fuite peut entraîner une grande augmentation de votre facture.**
    ...
    <div class="flex flex-col md:flex-row items-start mx-auto gap-6">
        <div class="md:w-1/2">
            <Image
                src={image2}
                alt="detecter-fuite-eau-compteur-2023-guide"
        ...
        <div class="md:w-1/2 text-left">
            ...
            <p>
               Le fournisseur d’eau, c’est un peu comme le super-héros de votre bande dessinée. Il s’assure que l’eau arrive jusqu’à votre compteur de façon sécurisée.
            </p>
        </div>
    </div>

Tout ce qui est avant le compteur est son territoire. Si une fuite se produit à ce niveau, c’est lui qui doit voler à la rescousse.

## Comment contacter le service eau en cas de fuite ?
Avant de paniquer et de crier « Au secours ! », prenez une grande respiration (et peut-être une gorgée d’eau).

La plupart des fournisseurs ont un numéro d’urgence, généralement inscrit sur votre facture.

Et non, ce n’est pas le même numéro que celui de votre pizzeria préférée.
...
<div class="bg-gray-100">
    <div class="flex flex-col md:flex-row items-start mx-auto gap-5">
        <div class="md:w-1/2 text-left">
            ...
            <p>
                La fuite d’eau, c’est comme une glace au soleil : ça peut faire fondre très rapidement votre portefeuille si vous n’y prêtez pas attention.
            </p>
            <h2>L’impact sur la facture d’eau</h2>
            <p>
                Vous voyez cette pile de pièces que vous économisiez pour vos vacances ?
                Eh bien, une fuite non détectée peut les faire disparaître comme par magie !
            </p>
            <h3>Excédant par rapport à la consommation moyenne</h3>
            <p>
                L’eau qui s’écoule constamment peut vous coûter une petite fortune. Imaginez que chaque goutte est une pièce de monnaie qui s’échappe de votre porte-monnaie.
                Oui, c’est douloureux à se l’imaginer …
            </p>
        </div>
        <div class="md:w-1/2">
            <Image
                src={image3}
                alt="fuite-impact-consommation-moyenne"
                loading="lazy"
                class="w-full h-auto rounded-xl shadow-md"
            />
        </div>
    ...
    ### Plafonnement facture eau selon la loi Warsmann
    Bonne nouvelle ! Grâce à cette loi, vous ne paierez pas pour toute cette eau gaspillée.
    
    C’est un peu comme si on vous offrait une deuxième glace après en avoir fait tomber une.  Attention toutefois, certaines conditions s’appliquent !
    
    ## Votre contrat d’assurance habitation
    L’assurance habitation, c’est notre parachute en cas de pépins.

    Mais, est-elle vraiment efficace contre les fuites d’eau ?

    ## Dégâts des eaux et couverture assurance
    L’assurance habitation couvre-t-elle les fuites ?

    Oui, mais c’est un peu comme un régime : il y a des conditions.

    Il est important de bien lire et de prendre connaissance son contrat et, en cas de doute, d’appeler son assureur. Sans oublier de croiser les doigts !

    ## Modèle de lettre pour plafonner la facture
    Nous ne sommes pas tous des écrivains …
    Heureusement, des modèles de lettre existent pour vous aider à communiquer avec votre fournisseur d’eau ou votre assureur.

    Vous pouvez <strong style="color:blue">[consulter quelques lettres existantes pour plafonner votre facture.](https://www.services-eau-france.fr/modeles-lettres/degrevement-facture-eau-fuite/)</strong>
</div>
...
<div class="flex justify-center items-center">
  <Image
    src={image4}
    alt="responsabilite fuite eau logement"
    loading="lazy"
...
L’univers des fuites d’eau est rempli d’idées reçues. Comme pour les légenurbaines, certaines sont vraies, d’autres … eh bien, disons simplemqu’elles ont besoin d’une clarification !

    <div class="flex flex-col md:flex-row items-start mx-auto gap-5">
        <div class="md:w-1/2 text-left">
            <h2>« Un petit égouttement n’est pas grave »</h2>
            <p>
            ...
            <h2>« Toutes les fuites sont visibles »</h2>
            <p>
            ...
            <h3>Détecter les fuites cachées</h3>
            <p>
        ...
        <div class="md:w-1/2">
            <Image
                src={image5}
                alt="kit-reparation-fuite-eau-compteur-image"
                loading="lazy"
                class="w-full h-auto rounded-xl shadow-md"
            />
        </div>
