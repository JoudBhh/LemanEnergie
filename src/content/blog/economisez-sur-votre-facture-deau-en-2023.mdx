...
author: ''
image: "art9-img1.jpg"
alt: 'economisez-sur-votre-facture-eau-en-2023'
width: ''
height: ''
tags: ['économie', 'eau']
...
import image2 from '../../images/art9-img2.jpg';
import image3 from '../../images/art9-img3.jpg';
import image4 from '../../images/art9-img4.jpg';
import image5 from '../../images/art9-img5.jpg';

<p class="flex justify-center">Découvrez comment économiser sur votre facture d'eau en 2023. Des astuces maison pour réduire votre consommation.</p>
<div class="bg-gray-100">
    ...
    **La part fixe est l’abonnement**, alors que **la part variable est directement liée à votre     consommation d’eau**.
    ...
    Ainsi, chaque litre que vous consommez ajoute quelques centimes à votre facture. Mais ce n’est pas tout! Des frais supplémentaires peuvent s’ajouter pour le traitement de l’eau potable et les servicesd’assainissement.
    
    La Conso indique que bien comprendre la structure de votre facture est la première étape pour     identifier les domaines d’économie. Et vous savez ce qu’ils disent : **« Un euro économisé est un eurogagné«** , ou dans ce cas, **« Un litre d’eau économisé est un centime gagné ! »**.
</div>
    ...
    <div class="flex flex-col md:flex-row items-start mx-auto gap-6">
        <div class="md:w-1/2 mb-10">
            <Image
                src={image2}
                alt="economisez-facture-eau"
                loading="lazy"
                class="w-full h-auto rounded-xl shadow-md"
            />
        </div>
        <div class="md:w-1/2 text-left">
            <h1>Les grandes sources de consommation d’eau dans la maison</h1>
            <p>
                ...
                D’après nos observations (et nous aimons observer), certains appareils, sont plus gourmands en eau que vous ne le pensez.
                Mais pas de jugement ici ! Passons en revue les principales sources de consommation d’eau dans la maison.
            </p>
        </div>
    </div>
...
<div class="bg-gray-100">
    <div class="flex flex-col md:flex-row items-start mx-auto gap-6">
        <div class="md:w-1/2 text-left">
            <h1>Comment traquer et réparer les fuites d’eau</h1>
            <p>
            ...
            <h2>Identifier les fuites courantes</h2>
            <p>
                Quelque part dans votre maison, une petite goutte d’eau se moque de vous.
            </p>
        </div>
                <div class="md:w-1/2">
            <Image
                src={image3}
                alt="fuites-robinet-economisez-goutte-eau"
                loading="lazy"
                class="w-full h-auto rounded-xl shadow-md"
            />
        </div>
    </div> 
    Non, vous ne devenez pas fou. C’est juste une petite fuite d’eau, se faufilant hors de son tuyau.
...
<div class="flex justify-center items-center">
  <Image
    src={image4}
    alt="systeme-arrosage-goutte-reduisez-facture"
    loading="lazy"
...
<div class="bg-gray-100">
    ...
    **Economiser l’eau ne nécessite pas de grands gestes héroïques.** C’est dans les petites actions quotidiennes que se trouvent les plus grandes économies.
    ...
    <div class="flex flex-col md:flex-row items-start mx-auto gap-6">
        <div class="md:w-1/2 text-left">
            <h1>L’impact des économies d’eau sur d’autres factures</h1>
            <p>
            ...
            <h2>Réduire la facture d’électricité en économisant l’eau</h2>
            <p>
                Tout d’abord, un petit jeu : essayez d’imaginer combien de fois par jour vous 
            </p>
        </div>
                <div class="md:w-1/2">
            <Image
                src={image5}
                alt="reduisez-consommation-eau-maison"
                loading="lazy"
                class="w-full h-auto rounded-xl shadow-md"
            />
        </div>
    </div>
utilisez de l’eau chaude. Douche, vaisselle, machine à laver … Et oui, cela monte vite !
Chaque fois que vous consommez de l’eau chaude, votre chauffe-eau entre en action, consommant de l’énergie (et vous faisant dépenser des euros supplémentaires).
